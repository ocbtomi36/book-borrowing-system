...
// 
router.post('/signup',validateAllowedFields(insertUpdateUserFields),[userValidator], validateAllowedFields(insertUpdateUserFields),[userValidator],incommingDataResult,UserDataValidateMiddleware.checkPinNumber,UserDataValidateMiddleware.checkEmail,authController.signup);
